...
export const ForWho = () => {
  return <section id="para-quien" className="py-12 sm:py-16 md:py-20">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 max-w-6xl mx-auto">
          {audiences.map((audience, index) => <div key={index} className="group p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border border-border/50 hover:border-primary/30 bg-card hover:bg-gradient-to-br hover:from-card hover:to-primary/5 transition-all duration-300 hover:shadow-card animate-fade-in" style={{
