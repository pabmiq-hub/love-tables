  ...
  return (
    <section className="relative min-h-screen bg-gradient-hero overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <Heart className="absolute top-1/4 left-1/4 w-6 h-6 text-primary/20 animate-float" style={{ animationDelay: '0s' }} />
        <Heart className="absolute top-1/3 right-1/4 w-4 h-4 text-primary/15 animate-float" style={{ animationDelay: '1s' }} />
        <Heart className="absolute bottom-1/3 left-1/3 w-5 h-5 text-primary/20 animate-float" style={{ animationDelay: '2s' }} />
        <Heart className="absolute top-1/2 right-1/3 w-3 h-3 text-accent/20 animate-float" style={{ animationDelay: '3s' }} />
      </div>
      ...
      <div className="relative container mx-auto px-4 py-20 flex flex-col items-center justify-center min-h-screen">
        ...
        {/* Main heading */}
        <h1 className="animate-fade-in text-5xl md:text-7xl font-display font-bold text-center max-w-4xl mb-6" style={{ animationDelay: '0.1s' }}>
          Conecta personas,
          <span className="text-gradient"> crea momentos</span>
        </h1>

        {/* Subtitle */}
        <p className="animate-fade-in text-lg md:text-xl text-muted-foreground text-center max-w-2xl mb-10" style={{ animationDelay: '0.2s' }}>
        ...
        {/* CTA Buttons */}
        <div className="animate-fade-in flex flex-col sm:flex-row gap-4 mb-16" style={{ animationDelay: '0.3s' }}>
          <Link to="/admin/login">
        ...
        {/* Features */}
        <div className="animate-fade-in grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl w-full" style={{ animationDelay: '0.4s' }}>
