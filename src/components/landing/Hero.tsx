  ...
  return (
    <section className="relative min-h-screen bg-gradient-hero overflow-hidden pt-16 md:pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden hidden sm:block">
        ...
        <div 
          className="absolute bottom-20 right-10 w-64 md:w-96 h-64 md:h-96 bg-accent/5 rounded-full blur-3xl animate-float" 
      ...
      <div className="relative container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 flex flex-col items-center justify-center min-h-[calc(100vh-64px)] md:min-h-[calc(100vh-80px)]">
        ...
        <div className="animate-fade-in mb-6 sm:mb-8">
          <span className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-primary/10 text-primary text-xs sm:text-sm font-medium">
            ...
            <span className="xs:hidden">Conecta personas</span>
          </span>
        </div>

        {/* Main heading */}
        <h1 
          className="animate-fade-in text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-display font-bold text-center max-w-5xl mb-4 sm:mb-6 leading-tight px-2" 
        ...
        {/* Subtitle */}
        <p 
          className="animate-fade-in text-base sm:text-lg md:text-xl text-muted-foreground text-center max-w-2xl mb-8 sm:mb-10 leading-relaxed px-2" 
        ...
        {/* CTA Buttons */}
        <div 
          className="animate-fade-in flex flex-col sm:flex-row gap-3 sm:gap-4 mb-10 sm:mb-16 w-full sm:w-auto px-4 sm:px-0" 
        ...
        {/* Features */}
        <div 
          className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-4xl w-full px-2 sm:px-0" 
        >
          <div 
            className="animate-fade-in flex flex-col sm:flex-col items-center sm:items-center text-center sm:text-center p-4 sm:p-6 rounded-2xl glass hover:scale-105 transition-transform duration-300 cursor-pointer"
        ...
        {/* Scroll Indicator */}
        <div 
          className="animate-fade-in mt-10 sm:mt-16 flex flex-col items-center cursor-pointer group"
