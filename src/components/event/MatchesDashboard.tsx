...
type ViewMode = "byMatch" | "byParticipant" | "bySelections";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-2 p-1 bg-muted rounded-lg w-fit flex-wrap">
        ...
        <Button
          variant={viewMode === "bySelections" ? "default" : "ghost"}
          size="sm"
          onClick={() => setViewMode("bySelections")}
        >
      ...
      {/* View by Selections - What each participant selected */}
      {viewMode === "bySelections" && (
        <div className="space-y-3">
